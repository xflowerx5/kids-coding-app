...
const Parent = (() => {
  ...
  App.registerScreen('parent-pin', () => {
    ...
    <div class="screen screen-parent-pin">
      <button class="btn-back pp-back" onclick="App.showScreen('splash')" aria-label="뒤로">←</button>
  ...
  App.registerScreen('parent-dashboard', async () => {
    ...
    <div class="screen screen-parent-dashboard">
      <div class="pd-header">
        <button class="btn-back" onclick="Parent.logout()" aria-label="나가기">←</button>
  ...
  function logout() {
    Sound.click();
    App.Storage.set('_entryMode', 'child');
